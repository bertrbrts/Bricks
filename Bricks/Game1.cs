...
namespace Bricks
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            // create game objects
            int paddleX = (screenWidth - gameContent.ImgPaddle.Width) / 2; // center the paddle on start.
            int paddleY = screenHeight - 100; // paddle will be 100 pixels from the bottom;
            paddle = new Paddle(paddleX, paddleY, screenWidth, spriteBatch, gameContent); // create the paddle
            wall = new Wall(1, 50, spriteBatch, gameContent); // BUILD THE WALL
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            {
                if (oldMouseState.X >= 0 || newMouseState.X < screenWidth)
                {
